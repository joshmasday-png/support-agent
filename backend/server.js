      ...
      <div class="grid">
        ...
        <div class="stack">
          ...
          <section class="card">
            ...
            <div class="note">Open Shopify theme editor → App embeds → Zypher Support Agent to change storefront presentation safely.</div>
          </section>
        </div>
      </div>
    </div>
      ...
      <div class="layout">
        ...
        <div class="stack">
          ...
          <section class="card">
            ...
            <div id="themeHint" class="note hidden" style="margin-top:12px">Open Shopify theme editor, then App embeds, then Zypher Support Agent. Use that area only for widget appearance and placement.</div>
          </section>
        </div>
      </div>
    </div>
